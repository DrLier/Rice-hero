...
import com.example.capstone.mainpage.ui.diagnosis.DiagnosisViewModel
...
class DiseaseFactory private constructor(private val diseaseRepository: DiseaseRepository) : ViewModelProvider.NewInstanceFactory(){
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        } else if (modelClass.isAssignableFrom(DiagnosisViewModel::class.java)) {
            return DiagnosisViewModel(diseaseRepository) as T
        }
